...
func NewAlutraFastidiousPlannerCdkStack(scope constructs.Construct, id string, props *AlutraFastidiousPlannerCdkStackProps) awscdk.Stack {
...
func main() {
	...
	NewAlutraFastidiousPlannerCdkStack(app, "AlutraFastidiousPlannerCdkStack", &AlutraFastidiousPlannerCdkStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
